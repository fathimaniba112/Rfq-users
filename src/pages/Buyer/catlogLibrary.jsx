      ...
      <div className="max-w-7xl mx-auto bg-white rounded-lg shadow-sm p-6">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
          ...
          <div className="flex flex-wrap gap-3">
            <button onClick={() => navigate('/buyer/inactive-catalog')} className="text-[#43624A] font-medium hover:underline text-sm">Show Inactive Items</button>
           <button onClick={() => navigate('/buyer/add-catalog')} className="bg-[#43624A] text-white px-4 py-2 rounded"
    >+ Add a New Item</button>
            <button onClick={() => navigate('/buyer/bulk-catalog')} className="border border-[#43624A] text-[#43624A] hover:bg-[#F5F2EA] px-4 py-2 rounded flex items-center gap-2 transition-colors text-sm">
