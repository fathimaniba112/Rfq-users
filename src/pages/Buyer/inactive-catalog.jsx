...
const  BuyerInactiveCatalogPage = () => {
          ...
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
            ...
            <div className="max-w-md">
              ...
              <p className="text-sm text-gray-500 leading-relaxed">
                ...
                data consistency and hygiene, completeness of information in your requisitions, 
            ...
            <div className="flex flex-wrap items-center gap-3">
              <button className="text-sm font-medium transition-colors hover:opacity-80" style={{ color: colors.primary }}>
                Show Active Items
              </button>
              <button className="flex items-center gap-2 px-4 py-2 border rounded-lg text-sm font-medium transition-all hover:bg-gray-50" style={{ borderColor: colors.primary, color: colors.primary }}>
                <Plus size={16} />
                Add a New Item
              </button>
              <button className="flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium text-white transition-opacity hover:opacity-90 shadow-sm" style={{ backgroundColor: colors.primary }}>
                <Upload size={16} />
                Bulk Upload
              </button>
            </div>
...
export default BuyerInactiveCatalogPage;