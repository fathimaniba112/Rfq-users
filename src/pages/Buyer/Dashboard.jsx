...
import BuyerStatCard from "./StatCard";
import BuyerPendingAction from "./PendingAction";
import BuyerRfqChart from "./RfqChart";
import BuyerRFQBreakdown from "./Breakdown";
import BuyerTableCard from "./Tablecard";
    ...
    <main className="p-8 bg-[#F5F2EA] min-h-screen font-sans">
      <div className="max-w-[1600px] mx-auto space-y-6">
          ...
          <div className="flex-[2] space-y-6">
            ...
            <section className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                <BuyerStatCard title="RFQ Created" value="13" d7="3" ytd="27" />
                <BuyerStatCard title="Est. RFQ Value (BHD)" value="0" d7="0" ytd="0" />
                <BuyerStatCard title="Supplier Responsiveness" value="9.4%" d7="7.7%" ytd="8.1%" />
                <BuyerStatCard title="Avg. Quotes/RFQ" value="45" d7="8" ytd="78" />
              </div>
            </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          {/* Active RFQs */}
          <BuyerTableCard title="Active RFQs">
          ...
          <BuyerTableCard title="Recent Purchase Orders">
          ...
          {/* Recent Quotations */}
          <BuyerTableCard title="Recent Quotations">
